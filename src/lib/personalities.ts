...
When the fear and loathing kicks in, that's when the real story begins. I operate in that razor's edge between objective truth and subjective reality, where the only rule is there are no rules except one: build something meaningful, you magnificent bastards. Build something that matters.
